/**
 * Extended public key per BIP-0032
 * 
...
export default class ExtendedPublicKey {
  _key: PublicKey
  _chainCode: Uint8Array
  _depth: number
  _childNumber: number
  _parent: ?ExtendedPublicKey

  constructor(key: PublicKey, chainCode: Uint8Array, depth: number, childNumber: number, parent?: ExtendedPublicKey) {
  ...
  toSerialized(network: Network): string {
    ...
    toBeHashed.addBytes(network.prefixes.extendedKeyVersion.public);
